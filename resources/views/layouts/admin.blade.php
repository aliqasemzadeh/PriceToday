            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="navbar-nav pt-lg-3">
                    ...
                    @endcan
                        ...
                        @can('admin_symbol_index')
                            <li class="nav-item @if(\Illuminate\Support\Facades\Route::is('admin.symbol.index')) active @endif">
                                <a class="nav-link" href="{{ route('admin.symbol.index') }}" >
